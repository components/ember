...
var Jt=void 0,Xt={get onerror(){return Jt}},Zt=void 0,en=new c(["sync","actions","destroy"],{sync:{before:z,after:V},defaultQueue:"actions",onBegin:function(e){Fe.currentRunLoop=e},onEnd:function(e,t){Fe.currentRunLoop=t},onErrorTarget:Xt,onErrorMethod:"onerror"})
...
this._direction=void 0,"fwd"===o?(e=ge(s,a),r&&u.log(" ",this.toString(),"->",e,s),this._oneWay?we(i,this._to,e):k(i,this._to,this,"toDidChange",function(){we(i,this._to,e)})):"back"===o&&(n=ge(i,this._to),r&&u.log(" ",this.toString(),"<-",n,i),k(s,a,this,"fromDidChange",function(){we(s,a,n)}))}},e}();(function(e,t){for(var n in t)t.hasOwnProperty(n)&&(e[n]=t[n])})(an,{from:function(e){var t=this
...
e["default"]="3.0.0-alpha.1-null+c6e3de6a"}),e("node-module",["exports"],function(e){var t="object"==typeof module&&"function"==typeof module.require
