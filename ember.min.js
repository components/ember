...
if(void 0===i||i.proto!==t)return Q(t[n])?oe(t,n):(r=i.readableCache(),void 0!==r?ve.get(r,n):void 0)}}function Z(t){var n=e.peekMeta(t)
...
if(this._chains=void 0,this._object=void 0,this.count=0,this._value=n,this._paths=void 0,i){if(r=e.value(),!K(r))return
this._object=r,$(this._object,this._key,this)}}return e.prototype.value=function(){var e
return void 0===this._value&&this._watching&&(e=this._parent.value(),this._value=X(e,this._key)),this._value},e.prototype.destroy=function(){this._watching&&(J(this._object,this._key,this),this._watching=!1)},e.prototype.copy=function(t){var n=new e(null,null,t),r=this._paths,i=void 0
...
t&&t.length>1&&(n=G(t),r=t.slice(n.length+1),o.unchain(n,r)),o.count--,o.count<=0&&(i[o._key]=void 0,o.destroy())},e.prototype.notify=function(e,t){e&&this._watching&&(n=this._parent.value(),n!==this._object&&(J(this._object,this._key,this),K(n)?(this._object=n,$(n,this._key,this)):this._object=void 0),this._value=void 0)
...
e["default"]="2.15.0-alpha.1-null+bd96516b"}),e("node-module",["exports"],function(e){var t="object"==typeof module&&"function"==typeof module.require
