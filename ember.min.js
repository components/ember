...
this.registry=e,this.owner=n.owner||null,this.cache=(0,t.dictionary)(n.cache||null),this.validationCache=(0,t.dictionary)(n.validationCache||null),this.factoryManagerCache=(0,t.dictionary)(n.factoryManagerCache||null),this[C]=void 0,this.isDestroyed=!1}function i(e,t){return e.registry.getOption(t,"singleton")!==!1}function o(e,t){return e.registry.getOption(t,"instantiate")!==!1}function s(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}
...
s.boot()
var a={engine:s}
return u.EMBER_ENGINES_MOUNT_PARAMS&&(a.modelReference=n.named.get("model")),a},n.prototype.layoutFor=function(e,t,n){var r=t.engine,i=r.lookup("template:application")
return n.getCompiledBlock(o.OutletLayoutCompiler,i)},n.prototype.getSelf=function(e){var t,n=e.engine,r=e.modelReference,o=n.factoryFor("controller:application"),s=o||(0,a.generateControllerFactory)(n,"application"),c=e.controller=s.create()
return u.EMBER_ENGINES_MOUNT_PARAMS&&(t=r.value(),e.modelRevision=r.tag.value(),c.set("model",t)),new i.RootReference(c)},n.prototype.getDestructor=function(e){var t=e.engine
return t},n.prototype.didRenderLayout=function(){},n.prototype.update=function(e){var t,n,r,i
u.EMBER_ENGINES_MOUNT_PARAMS&&(t=e.controller,n=e.modelReference,r=e.modelRevision,n.tag.validate(r)||(i=n.value(),e.modelRevision=n.tag.value(),t.set("model",i)))},n}(s["default"]),l=new c
...
e["default"]="2.15.0-alpha.1-null+d338c608"}),e("node-module",["exports"],function(e){var t="object"==typeof module&&"function"==typeof module.require
