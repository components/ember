...
var s,a,u,l,c,p,f,m,g,v,y,b,_,w=(0,r.meta)(this),E=w.proto
if(w.proto=this,i&&(w.factory=i,i=null),t)for(s=t,t=null,a=this.concatenatedProperties,u=this.mergedProperties,l=0;l<s.length;l++)if(c=s[l])for(p=Object.keys(c),f=0;f<p.length;f++)m=p[f],g=c[m],(0,r.detectBinding)(m)&&w.writeBindings(m,g),v=this[m],y=null!==v&&"object"==typeof v&&v.isDescriptor?v:void 0,a&&a.length>0&&a.indexOf(m)>-1&&(b=this[m],g=b?"function"==typeof b.concat?b.concat(g):(0,n.makeArray)(b).concat(g):(0,n.makeArray)(g)),u&&u.length>0&&u.indexOf(m)>-1&&(_=this[m],g=(0,n.assign)({},_,g)),y?y.set(this,m,g):"function"!=typeof this.setUnknownProperty||m in this?this[m]=g:this.setUnknownProperty(m,g)
...
e["default"]="2.15.0-alpha.1-null+d42a2a6c"}),e("node-module",["exports"],function(e){var t="object"==typeof module&&"function"==typeof module.require
