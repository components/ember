...
return s&&s!==t?o=i._dispatchEvent(s,e,r,n):n&&(o=i._bubbleEvent(n,e,r)),o}),e.on(n+".ember","[data-ember-action]",function(e){for(var t=e.currentTarget.attributes,n=t.length,i=[],s=0;s<n;s++){var a=t.item(s),u=a.name
0===u.indexOf("data-ember-action-")&&(i=i.concat(o.default.registeredActions[a.value]))}if(0!==i.length)for(var l=0;l<i.length;l++){var c=i[l]
if(c&&c.eventName===r)return c.handler(e)}}))},_findNearestEventManager:function(e,t){for(var r=null;e&&(r=n.get(e,"eventManager"),!r||!r[t]);)e=n.get(e,"parentView")
...
e.default="2.12.0-alpha.1-canary+177ec98a"}),s("internal-test-helpers/apply-mixins",["exports","ember-utils"],function(e,t){"use strict"
