...
n.ControllerMixin.reopen({concatenatedProperties:["queryParams"],queryParams:null,_qpDelegate:null,_qpChanged:function(e,n){n=n.substr(0,n.length-3)
var r=e._qpDelegate,i=t.get(e,n)
r(n,i)},transitionToRoute:function(){for(var e=t.get(this,"target"),n=e.transitionToRoute||e.transitionTo,i=arguments.length,o=Array(i),s=0;s<i;s++)o[s]=arguments[s]
...
e.default="2.12.0-alpha.1-canary+78e3e0e7"}),s("internal-test-helpers/apply-mixins",["exports","ember-utils"],function(e,t){"use strict"
