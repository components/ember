 ...
 * @version   1.13.0-beta.1+canary.1a185ef1
 */
...
enifed('ember-metal/core', ['exports'], function (exports) {
  ...
  */
  ...
  /**
    @property VERSION
    @type String
    @default '1.13.0-beta.1+canary.1a185ef1'
    @static
  */
  Ember.VERSION = '1.13.0-beta.1+canary.1a185ef1';
...
enifed('ember-template-compiler/system/compile_options', ['exports', 'ember-metal/core', 'ember-template-compiler/plugins'], function (exports, Ember, plugins) {
  ...
  */
  ...
  exports['default'] = function () {
    ...
    return {
      revision: "Ember@1.13.0-beta.1+canary.1a185ef1",
