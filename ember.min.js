...
return a?s.set(t,n,r):!t.setUnknownProperty||void 0!==s||n in t?s!==r&&(o=e.peekMeta(t),w(t,n,o),t[n]=r,E(t,n,o)):t.setUnknownProperty(n,r),r}function se(e,t,n,i){var o=t.split("."),s=o.pop(),a=o.length>0?o.join("."):s,u=re(e,a)
if(!u){if(i)return
throw new r.Error('Property set failed: object in path "'+a+'" could not be found or was destroyed.')}return oe(u,s,n)}function ae(e,t,n){return oe(e,t,n,!0)}function ue(e,t){var n=e.indexOf("{")
...
e["default"]="2.16.0-alpha.1-null+58c0faa0"}),e("node-module",["exports"],function(e){var t="object"==typeof module&&"function"==typeof module.require
