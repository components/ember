...
for(t=0;t<o.length;t++)n=o[t],r=i[n],r.destroy&&r.destroy()}function m(e){d(e),e.cache.dict=(0,t.dictionary)(null)}function g(e,t){var n=e.cache[t]
...
r.prototype={lookup:function(e,t){return s(this,this.registry.normalize(e),t)},destroy:function(){d(this),this.isDestroyed=!0},reset:function(e){void 0!==e?g(this,this.registry.normalize(e)):m(this)},ownerInjection:function(){var e
...
e["default"]="2.17.0-beta.1-null+a613289f"}),e("node-module",["exports"],function(e){var t="object"==typeof module&&"function"==typeof module.require
