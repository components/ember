...
if(t){var i=void 0
for(n=0;n<t.length;n++)if(i=t[n].handler,i===e)return t[n+r]}}function p(e,n,i,o){var s,a=o&&o.into&&o.into.replace(/\//g,"."),u=o&&o.outlet||"main",c=void 0,p=void 0
n?(c=e.routeName,p=e.templateName||c):(c=i.replace(/\//g,"."),p=c)
var h=(0,t.getOwner)(e),f=o&&o.controller
if(f||(f=n?e.controllerName||h.lookup("controller:"+c):h.lookup("controller:"+c)||e.controllerName||e.routeName),"string"==typeof f&&(s=f,f=h.lookup("controller:"+s),!f))throw new r.Error("You passed `controller: '"+s+"'` into the `render` method, but no such controller could be found.")
o&&o.model&&f.set("model",o.model)
var d=h.lookup("template:"+p),m=void 0
a&&(m=l(e))&&a===m.routeName&&(a=void 0)
var g={owner:h,into:a,outlet:u,name:c,controller:f,template:d||e._topLevelViewTemplate,ViewClass:void 0}
...
if(p)for(f=Object.keys(p),m=0;m<f.length;m++)g=f[m],v=p[g],(0,r.detectBinding)(g)&&E.writeBindings(g,v),y=this[g],b=null!==y&&"object"==typeof y&&y.isDescriptor?y:void 0,u&&u.length>0&&u.indexOf(g)>-1&&(_=this[g],v=_?"function"==typeof _.concat?_.concat(v):(0,n.makeArray)(_).concat(v):(0,n.makeArray)(v)),l&&l.length>0&&l.indexOf(g)>-1&&(w=this[g],v=(0,n.assign)({},w,v)),b?b.set(this,g,v):"function"!=typeof this.setUnknownProperty||g in this?this[g]=v:this.setUnknownProperty(g,v)}h(this,E),this.init.apply(this,arguments),this[d](),E.proto=C,(0,r.finishChains)(E),(0,r.sendEvent)(this,"init",void 0,void 0,void 0,E)}return o.willReopen=function(){e&&(o.PrototypeMixin=r.Mixin.create(o.PrototypeMixin)),e=!1},o._initProperties=function(e){t=e},o._initFactory=function(e){i=e},o.proto=function(){var t=o.superclass
...
e["default"]="2.15.0-alpha.1-null+d5f21b52"}),e("node-module",["exports"],function(e){var t="object"==typeof module&&"function"==typeof module.require
