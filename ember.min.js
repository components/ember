...
var Ft=void 0,Vt={get onerror(){return Ft}},zt=void 0,Ht=new u(["sync","actions","destroy"],{sync:{before:B,after:F},defaultQueue:"actions",onBegin:function(e){Ne.currentRunLoop=e},onEnd:function(e,t){Ne.currentRunLoop=t},onErrorTarget:Vt,onErrorMethod:"onerror"})
...
for(i in a)a.hasOwnProperty(i)&&this.setupHandler(s,i,a[i],h)},setupHandler:function(e,t,n,r){var i,o,a,c=this,l=this
null!==n&&(u?(e.on(t+".ember",".ember-view",function(e,t){var i=r[this.id],o=!0,s=l.canDispatchToEventManager?l._findNearestEventManager(i,n):null
return s&&s!==t?o=l._dispatchEvent(s,e,n,i):i&&(o=l._bubbleEvent(i,e,n)),o}),e.on(t+".ember","[data-ember-action]",function(e){var t,r,i,o,a=e.currentTarget.attributes,u=[]
...
return i&&(o=c._bubbleEvent(i,t,n)),o},o=function(e,t){var r,i,o,a,u,c,l,p=e.getAttribute("data-ember-action"),h=s["default"].registeredActions[p]
...
break}t=t.parentNode}while(t&&1===t.nodeType)},e.addEventListener(t,a)))},_getViewRegistry:function(){var e=(0,t.getOwner)(this),n=e&&e.lookup("-view-registry:main")||a["default"]
...
e["default"]="3.1.0-canary+629c5a8c"}),e("node-module",["exports"],function(e){var t="object"==typeof module&&"function"==typeof module.require
