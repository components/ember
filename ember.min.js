...
if(l)for(p=Object.keys(l),f=0;f<p.length;f++)d=p[f],g=l[d],(0,r.detectBinding)(d)&&w.writeBindings(d,g),v=this[d],y=null!==v&&"object"==typeof v&&v.isDescriptor?v:void 0,a&&a.length>0&&a.indexOf(d)>=0&&(b=this[d],g=b?"function"==typeof b.concat?b.concat(g):(0,n.makeArray)(b).concat(g):(0,n.makeArray)(g)),u&&u.length&&u.indexOf(d)>=0&&(_=this[d],g=(0,n.assign)({},_,g)),y?y.set(this,d,g):"function"!=typeof this.setUnknownProperty||d in this?this[d]=g:this.setUnknownProperty(d,g)}h(this,w),this.init.apply(this,arguments),this[m](),w.proto=E,(0,r.finishChains)(w),(0,r.sendEvent)(this,"init")}return i.willReopen=function(){e&&(i.PrototypeMixin=r.Mixin.create(i.PrototypeMixin)),e=!1},i._initProperties=function(e){t=e},i.proto=function(){var t=i.superclass
...
e["default"]="2.14.0-alpha.1-null+b3c03773"}),e("node-module",["exports"],function(e){var t="object"==typeof module&&"function"==typeof module.require
