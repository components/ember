...
var r=e.split(":")[0]
return n=this._typeOptions[r],n&&void 0!==n[t]?n[t]:this.fallback?this.fallback.getOption(e,t):void 0},e.prototype.typeInjection=function(e,t,n){var r=(n.split(":")[0],this._typeInjections[e]||(this._typeInjections[e]=[]))
r.push({property:t,fullName:n})},e.prototype.injection=function(e,t,n){this.validateFullName(n)
...
e["default"]="2.17.0-alpha.1-null+3769623e"}),e("node-module",["exports"],function(e){var t="object"==typeof module&&"function"==typeof module.require
