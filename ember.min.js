...
return"function"==typeof this["class"]._initFactory?this["class"]._initFactory(this):(0,t.setOwner)(s,this.owner),this["class"].create(s)},e}(),R=/^[^:]+:[^:]+$/,S=function(){function e(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
...
return null!==this.fallback&&(o=this.fallback.knownForType(e)),null!==this.resolver&&this.resolver.knownForType&&(s=this.resolver.knownForType(e)),(0,t.assign)({},o,a,s)},e.prototype.isValidFullName=function(e){return R.test(e)},e.prototype.getInjections=function(e){var t=this._injections[e]||[]
...
e.Registry=S,e.privatize=function(e){var n=e[0],r=x[n]
if(r)return r
...
return void 0!==n&&n.peekWatching(t)||0}function R(e,t,n){fe(t)?E(e,t,n):X(e,t,n)}function S(e){return e+":change"}function x(e){return e+":before"}function A(e,t,n,r){return p(e,S(t),n,r),O(e,t),this}function T(e,t,n,r){return R(e,t),h(e,S(t),n,r),this}function P(e,t,n,r){return p(e,x(t),n,r),O(e,t),this}function k(e,t,n,r,i){return f(e,S(t),n,r,i)}function N(e,t,n,r){return R(e,t),h(e,x(t),n,r),this}function j(e,t,n){var r=void 0===n?ue(e):n
...
return!(void 0!==r&&r._volatile===!1)}function ne(){return new Ct}function re(e){return new Rt(null,null,e)}function ie(e,t,n){var r=ce(e)
...
if(i!==St)return i}function Ae(e,t){throw new r.Error("Cannot set read-only property '"+t+"' on object: "+n.inspect(e))}function Te(e,t,n){return Y(e,t,null),be(e,t,n)}function Pe(e){var t,n=[],r=void 0
...
return void 0===i[t]&&(a=o[t]),a||(a=le(s,t,e)),void 0!==a&&a instanceof Se?(r=Object.create(r),r._getter=n.wrap(r._getter,a._getter),a._setter&&(r._setter?r._setter=n.wrap(r._setter,a._setter):r._setter=a._setter),r):r}function Ge(e,t,r,i,o){var s=void 0
...
void 0!==r&&void 0!==r[t]&&(r[t]=void 0,Re(this,e,t,n))}}},Wt.get=function(e,t){if(this._volatile)return this._getter.call(e,t)
...
return s&&a===u?u:(j(e,t,r),s||Ce(this,e,t,r),i[t]=void 0===u?St:u,M(e,t,r),u)},Wt.teardown=function(e,t,n){if(!this._volatile){var r=n.readableCache()
void 0!==r&&void 0!==r[t]&&(Re(this,e,t,n),r[t]=void 0)}},xe.set=function(e,t,n){void 0===n?e[t]=St:e[t]=n},xe.get=function(e,t){var n=e[t]
if(n!==St)return n},xe.remove=function(e,t){e[t]=void 0}
...
Kt.prototype._meta=void 0,Kt.prototype.meta=Se.prototype.meta
...
var mn=at.prototype,gn=Se.prototype,yn=Kt.prototype
mn._super$Constructor=Se,mn.get=gn.get,mn.readOnly=gn.readOnly,mn.teardown=gn.teardown
...
return t.length>0&&i.property.apply(i,t),i},e.cacheFor=xe,e.ComputedProperty=Se,e.alias=function(e){return new Kt(e)},e.merge=function(e,t){if(null===t||"object"!=typeof t)return e
...
return void 0!==t?t.watchedEvents():[]},e.isNone=De,e.isEmpty=Ie,e.isBlank=Le,e.isPresent=function(e){return!Le(e)},e.run=Fe,e.ObserverSet=mt,e.beginPropertyChanges=z,e.changeProperties=H,e.endPropertyChanges=V,e.overrideChains=B,e.propertyDidChange=M,e.propertyWillChange=j,e.PROPERTY_DID_CHANGE=gt,e.defineProperty=Y,e.Descriptor=Q,e._hasCachedComputedProperties=function(){Et=!0},e.watchKey=J,e.unwatchKey=X,e.ChainNode=Rt,e.finishChains=function(e){var t=e.readableChainWatchers()
...
return d(e,o,n,r,i)},e.addObserver=A,e.observersFor=function(e,t){return g(e,S(t))},e.removeObserver=T,e._addBeforeObserver=P,e._removeBeforeObserver=N,e.Mixin=pn,e.aliasMethod=function(e){return new st(e)},e._beforeObserver=function(){for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
...
s.__hasSuper=!1
var C=Object.prototype.toString,R=Array.isArray,S=i("NAME_KEY"),x=Object.prototype.toString,A="function"==typeof Proxy
...
e["default"]="3.0.0-alpha.1-null+a713856e"}),e("node-module",["exports"],function(e){var t="object"==typeof module&&"function"==typeof module.require
...
var Se=Object.prototype.hasOwnProperty,xe=function(e){function n(n,r){var i=!(arguments.length>2&&void 0!==arguments[2])||arguments[2],o=arguments[3]
