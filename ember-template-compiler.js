...
enifed('ember-metal/chains', ['exports', 'ember-metal/core', 'ember-metal/property_get', 'ember-metal/utils', 'ember-metal/watch_key'], function (exports, _emberMetalCore, _emberMetalProperty_get, _emberMetalUtils, _emberMetalWatch_key) {
  ...
  function flushPendingChains() {
    ...
    _emberMetalCore.default.warn('Watching an undefined global, Ember expects watched globals to be ' + 'setup by the time the run loop is flushed, check for typos', pendingQueue.length === 0);
  }
...
enifed('ember-metal/core', ['exports'], function (exports) {
  ...
  */
  ...
  /**
    ...
    @property VERSION
    @type String
    @default '2.0.0-canary+6b5e3470'
    @static
    @public
  */
  Ember.VERSION = '2.0.0-canary+6b5e3470';
  ...
  exports.default = function (_options) {
    ...
    options.buildMeta = function buildMeta(program) {
      return {
        ...
        revision: 'Ember@2.0.0-canary+6b5e3470',
        loc: program.loc,
